<?php
// URLs absolutas para imágenes en correos — siempre deben ser hardcodeadas
// Los clientes de correo necesitan URLs públicas absolutas
$imgBase = 'https://blog.bricklyhomes.com';
$img = function ($path) use ($imgBase) {
    return $imgBase . '/' . ltrim($path, '/');
};
?>
<!DOCTYPE html>
<html lang="es">
                    ...
                    <tr>
                        <td align="left">
                            <a href="https://www.bricklyhomes.com" target="_blank">
                                <img src="<?= $img('images/newsletters/logo_negro.png') ?>" alt="Brickly Homes" width="160" style="display:block; border:0; font-family:sans-serif; font-size:18px; line-height:20px; color:#111111; font-weight:bold;">
                            </a>
                        </td>
                        <td align="right" style="vertical-align: middle;">
                            <img src="<?= $img('images/newsletters/newsletter.png') ?>" alt="Suscripción" width="28" height="28" style="display:block; border:0;">
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            ...
                            <td class="col-mobile-100 hero-img-container" width="300" style="width: 300px; max-width: 300px; vertical-align: top;">
                                <img src="<?= $img('images/newsletters/subBlog/banner.png') ?>" alt="Brickly Blog" width="300" style="display:block; width:100%; max-width: 300px; height:auto; border:0;">
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <tr>
            <td style="padding: 0 20px 50px 20px; font-size: 0; text-align: center;">
                <div class="col-33" style="display: inline-block; width: 100%; max-width: 180px; vertical-align: top; font-size: 13px;">
                    <img src="<?= $img('images/newsletters/subBlog/articulos.png') ?>" alt="Artículos" width="40" height="40" style="display:inline-block; margin-bottom:15px;">
                ...
                <div class="col-33" style="display: inline-block; width: 100%; max-width: 198px; vertical-align: top; font-size: 13px; border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0;">
                    <img src="<?= $img('images/newsletters/subBlog/tendencias.png') ?>" alt="Consejos" width="40" height="40" style="display:inline-block; margin-bottom:15px;">
                ...
                <div class="col-33" style="display: inline-block; width: 100%; max-width: 180px; vertical-align: top; font-size: 13px;">
                    <img src="<?= $img('images/newsletters/subBlog/novedades.png') ?>" alt="Novedades" width="40" height="40" style="display:inline-block; margin-bottom:15px;">
            ...
            <td style="padding: 35px 20px 40px 20px; font-size: 0;">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="vertical-align: middle; padding-right: 14px;">
                                <img src="<?= $img('images/newsletters/Ayuda.png') ?>" alt="Dudas" width="36" height="36" style="display:block;">
                            </td>
                ...
                <div class="col-mobile-100" style="display: inline-block; width: 100%; max-width: 270px; vertical-align: top; font-size: 14px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td style="vertical-align: middle; padding-right: 14px;">
                                <img src="<?= $img('images/newsletters/Cuenta.png') ?>" alt="Cuenta" width="36" height="36" style="display:block;">
                            </td>
                            <td style="vertical-align: middle;">
                    ...
                    <tr>
                        <td style="font-size: 0; padding-bottom: 20px;">
                            <div class="col-mobile-100 text-center-mobile" style="display: inline-block; width: 100%; max-width: 280px; vertical-align: middle; margin-bottom: 20px;">
                                <a href="https://www.bricklyhomes.com" target="_blank">
                                    <img src="<?= $img('images/newsletters/logo_blanco.png') ?>" alt="Brickly Homes" width="140" style="border:0; display: inline-block;">
                                </a>
                            </div>
                            <div class="col-mobile-100 text-center-mobile" style="display: inline-block; width: 100%; max-width: 280px; vertical-align: middle; text-align: right; margin-bottom: 20px;">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="display:inline-block;">
                                    <tr>
                                        <td style="padding: 0 10px;"><a href="https://www.facebook.com/profile.php?id=61588999228778" target="_blank"><img src="<?= $img('images/newsletters/FB.png') ?>" alt="Facebook" width="20" height="20"></a></td>
                                        <td style="padding: 0 8px;"><a href="https://wa.me/50237649719" target="_blank"><img src="<?= $img('images/newsletters/WS.png') ?>" alt="WhatsApp" width="18" height="18"></a></td>
                                        <td style="padding: 0 8px;"><a href="https://www.instagram.com/bricklyoficial/" target="_blank"><img src="<?= $img('images/newsletters/IG.png') ?>" alt="Instagram" width="18" height="18"></a></td>
                                        <td style="padding: 0 8px;"><a href="https://www.linkedin.com/company/bricklygt/" target="_blank"><img src="<?= $img('images/newsletters/IN.png') ?>" alt="LinkedIn" width="18" height="18"></a></td>
                                        <td style="padding: 0 8px;"><a href="https://www.tiktok.com/@bricklyhomes" target="_blank"><img src="<?= $img('images/newsletters/TT.png') ?>" alt="TikTok" width="18" height="18"></a></td>
                                    </tr>
                                </table>
                            </div>
                        </td>
