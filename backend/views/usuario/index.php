...
<div class="usuario">
    <h3 style="color: var(--bs-dark);"><?= Html::encode($this->title)?> <?= Html::a('<i class="fa fa-plus"></i> Añadir nuevo usuario', ['/usuario/createuser'], ['class'=>'btn text-white', 'style' => 'font-size: 14px; background: #FF0461; border-radius: 4px; color: #fff !important;']) ?></h3>
    <hr>
