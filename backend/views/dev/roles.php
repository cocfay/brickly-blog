...
<div class="HomeRole">
    ...
    <div>
        <button type="button" class="btn btn-primary createrole-open" data-toggle="modal" data-target="#modal-create"><i class="fa fa-plus"></i> Añadir rol</button>
    </div>
    <br> 
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        ...
                                        'update' => function($url, $model){
                                            return '<button type="button" class="btn btn-primary update roleupdate" idrole="'.$model->RoleID.'" data-toggle="modal" data-target="#modal-update"><i class="fa fa-edit"></i></button>';
                                        }
