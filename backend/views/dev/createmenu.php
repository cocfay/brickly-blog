    ...
    <h1 style="color: var(--color-principal);"><?=($ModelsMenuByRole->isNewRecord)? 'Crear menú' : 'Actualizar menú'; ?> </h1>
     <div class="row-fluid">
            ...
            <div class="customer-form">
                ...
                <div class="row SingleMenu" style="<?php if($ModelsMenuByRole->isNewRecord): echo 'display:none;'; elseif($MenuModel->Type == 0): echo 'display:none;'; endif; ?>">
                    <div class="col-sm-6">
                        <?= $form->field($MenuModel, 'Path')->textInput(['maxlength' => true,'class'=>'form-control val-vaciar', 'placeholder'=>'view']) ?>
                    </div>
                </div>

                <div class="panel panel-default mt-4">
                    <div class="panel-heading"><h3><i class="fa fa-cogs"></i>Menú de configuración</h3></div>
                    <div class="panel-body">

                        <div class="container-items-role"><!-- widgetContainer -->
                            <div class="item-role panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <h4 class="panel-title pull-left">Selecccionar Rol</h4>
                        ...
                        <div class="NosingleMenu" style="<?php if($ModelsMenuByRole->isNewRecord): echo''; elseif($MenuModel->Type == 1): echo 'display:none;'; endif; ?>">
                        ...
                        <div class="container-items my-4"><!-- widgetContainer -->
                        <?php foreach ($PagesModel as $i => $modelPages): ?>
                            <div class="item panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <h3 class="panel-title pull-left">Páginas</h3>
                                    <div class="pull-right">
                                        <button type="button" class="add-item btn btn-success py-1"><i class="fa-solid fa-plus"></i></button>
                                        <button type="button" class="remove-item btn btn-danger py-1"><i class="fa-solid fa-minus"></i></button>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-6">
                                            <?= $form->field($modelPages, "[{$i}]PagePath")->textInput(['maxlength' => true,'class'=>'form-control val-vaciar','placeholder'=>'view']) ?>
                                        </div>
                                        <div class="col-md-12 col-sm-6">
                                            <?= $form->field($modelPages, "[{$i}]ClassIcon")->textInput(['maxlength' => true,'class'=>'form-control val-vaciar','placeholder'=>'fa fa-circle']) ?>
                                        </div>
                                    </div><!-- .row -->
                                   <!-- .row -->
                                </div>
                ...
                <div class="form-group mt-4" style="width: fit-content">
                    <?= Html::submitButton($ModelsMenuByRole->isNewRecord ? 'Crear' : 'Actualizar', ['class' => 'btn btn-primary click-confirm', 'style'=>'width:100%;',
