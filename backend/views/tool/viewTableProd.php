<?php
    ...
    $this->title = 'Proyectos en producción';
       ...
       /*  $column[] = [
        ...
        $column[] = [
            ...
            'buttons' => [
                ...
                'view' => function($url, $model) use ($ps){

                    if(count($ps) > 0){
                        return Html::a('<span class="fa fa-eye"></span>', ['check-policy', 'id' => $model->ProjectWeclickID], ['class' => "btn btn-info",
                        'title' => 'Estándares']);
                    }else
                        return ''; 
                },
    ...
    <div class="modal fade" id="addws" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content p-4">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'TypeProject')->dropDownList($listTip, ['prompt' => 'Seleccione...']) ?>
                </div>
                <div class="col-md-6">
    ...
    <div class="modal fade" id="edit-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content p-4">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'TypeProject')->dropDownList($listTip, ['prompt' => 'Seleccione...', 'id' => 'e-typeproject']) ?>
                </div>
                <div class="col-md-6">
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.post('$url', {id: id}, function(resp){
                ...
                $.post('$url', {id: e.target.dataset.id}, function(resp){
                    ...
                    $('#e-typeproject').val(resp.TypeProject)
