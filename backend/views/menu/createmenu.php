     ...
     <div class="row-fluid">
            ...
            <div class="customer-form">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading mt-3"><h4 class="d-flex gap-1"><i class="fa fa-cogs"></i>Menú de configuración</h4></div>
                    <div class="panel-body">

                        <div class="container-items-role"><!-- widgetContainer -->
                            <div class="item-role panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <h5 class="panel-title pull-left">Selecccionar Rol</h5>
                        ...
                        <?php foreach ($PagesModel as $i => $modelPages): ?>
                            <div class="item panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right d-flex gap-2 h-100">
                                        <button type="button" class="add-item btn btn-success btn-xs" style="height: 30px; display: grid; place-items: center;"><i class="fa-solid fa-plus"></i></button>
                                        <button type="button" class="remove-item btn btn-danger btn-xs" style="height: 30px; display: grid; place-items: center;"><i class="fa-solid fa-minus"></i></button>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                ...
                <div class="form-group" style="width: 85px;">
                    <?= Html::submitButton($ModelsMenuByRole->isNewRecord ? 'Crear' : 'Actualizar', ['class' => 'btn btn-primary click-confirm',
