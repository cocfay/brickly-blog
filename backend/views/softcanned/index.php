<?php 
  ...
  $this->title = 'Software enlatado';
?>

<div class="container-fluid">
  <h1 style="color: var(--color-principal);">Software enlatado</h1>
    <hr>
    <div class="row">
      <div class="col-6">
        <a href="<?= Url::to(['add']) ?>" class="btn"><i class="fa fa-plus"></i> Nuevo</a>
      </div>
            ...
            'buttons' => [
                'delete' => function($url, $model){
                    return Html::a('<span class="fa fa-trash" title="Eliminar"></span>', ['delete', 'id' => $model->PorfolioID], [
                        ...
                        'text-alert'  => '¿Estás seguro?. ¿Deseas quitar ['.$model->Title.'] de software enlatado?',
                    ]);
                },
