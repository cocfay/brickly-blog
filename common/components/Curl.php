...
class Curl
{
    ...
    public function postCoptions($url,$data,$Noptions =[],$debug = false){
        $options = $this->getOptions();
        $options[CURLOPT_POST] = true;
        $options[CURLOPT_POSTFIELDS] = $data;
        foreach ($Noptions as $key => $value) {
            $options[$key] = $value;
        }
        return $this->exec($url, $options, $debug);
    ...
    public function getCoptions($url,$Noptions =[],$debug = false){
        $options = $this->getOptions();
        foreach ($Noptions as $key => $value) {
            $options[$key] = $value;
        }
    ...
    public function putCoptions($url, $data = null, $Noptions = [], $debug = false)
    {
        $options =  $this->getOptions();
        $options[CURLOPT_POSTFIELDS] = $data;
    ...
    public function patchCoptions($url, $data = array(),$Noptions = [] , $debug = false)
    {
        $params = array();
        $url = $this->buildUrl($url, $params);
    ...
    public function deleteCoptions($url, $Noptions = [], $debug = false)
    {
